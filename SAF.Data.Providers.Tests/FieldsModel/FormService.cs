// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FormService.cs" company="TractManager, Inc.">
...
namespace SAF.Data.Providers.Tests.FieldsModel
{
    ...
    public class FormService
    {
        ...
        {
            return
                this.formRepository.SearchForms(nameSearch)
                    .Select(form => new FormSearchResult { FormId = form.FormId.GetValueOrDefault(), Name = form.Name });
        }
