...
namespace SAF.Data.Providers.Tests.FieldsModel
{
    ...
    internal static class Generate
    {
        ...
        /// </summary>
        private static readonly List<Type> UnifiedPropertyTypes = new List<Type>
                                                                     {
                                                                         typeof(long),
                                                                         typeof(double),
                                                                         typeof(decimal),
        ...
        /// </summary>
        private static readonly List<UnifiedFieldType> NumericFieldTypes = new List<UnifiedFieldType>
                                                                              {
        ...
        /// </summary>
        private static readonly List<UnifiedFieldType> TextFieldTypes = new List<UnifiedFieldType>
                                                                           {
                                                                               UnifiedFieldType.SingleField,
                                                                               UnifiedFieldType.DropDownList,
                                                                               UnifiedFieldType.PickList,
        ...
        {
            var person = new Person(2345) { FirstName = "Some", LastName = "Dood" };
        ...
        /// </returns>
        public static IEnumerable<UnifiedFieldValue> CreateUnifiedFieldValues(Person person)
        {
            var unifiedDate = new UnifiedField("MyDateField", UnifiedFieldType.DatePicker, UnifiedValueType.Date, 459345)
            {
                Caption =
                                          "My date field that I like to use",
                Label =
                                          "Put in the date here",
                SourceType = "Custom",
                ToolTip =
                                          "Enter in a date so that it will be saved"
            };

            var unifiedIdentifier = new UnifiedField("User.UserId", UnifiedFieldType.DropDownList, UnifiedValueType.Identifier, 4343654)
            {
                Caption =
            ...
            var unifiedEnumeration = new UnifiedField("MyCustomEnum", UnifiedFieldType.PickList, UnifiedValueType.Integer, 63297)
            {
                Caption =
            ...
            var unifiedInteger = new UnifiedField("MyIntegerField", UnifiedFieldType.SingleField, UnifiedValueType.Integer, 8756)
            {
                Caption =
            ...
            var unifiedCurrency = new UnifiedField("MyCurrencyField", UnifiedFieldType.SingleField, UnifiedValueType.Currency, 3243235)
            {
                Caption =
            ...
            var unifiedNumeric = new UnifiedField("MyNumericField", UnifiedFieldType.SingleField, UnifiedValueType.Numeric, 98745)
            {
                Caption =
            ...
            var unifiedText = new UnifiedField("MyTextField", UnifiedFieldType.TextBox, UnifiedValueType.Text, 4434345)
            {
                Caption =
                                          "My text field that I like to use",
                Label =
                                          "Put in the text here",
                SourceType = "Custom",
                ToolTip =
            ...
            var unifiedSourceValue1 = new UnifiedSourceValue(unifiedEnumeration, 392774)
            {
            ...
            var unifiedSourceValue2 = new UnifiedSourceValue(unifiedEnumeration, 3242323)
            {
                Caption = "Caption Planet",
                Name = "Enum2",
                Order = 2,
                StringValue = "65"
            };

            var unifiedSourceValue3 = new UnifiedSourceValue(unifiedEnumeration, 76576657)
            {
        ...
        /// An <see cref="IEnumerable{T}"/> of <see cref="FormSubmissionValue"/> items.
        /// </returns>
        public static IEnumerable<FormSubmissionValue> CreateFormSubmissionValues(bool valuesExist, FormSubmission submission, Person person)
        {
            var unifiedDate = new UnifiedField("MyDateField", UnifiedFieldType.DatePicker, UnifiedValueType.Date, 459345)
            {
                Caption =
        ...
        public static UnifiedField GenerateSystemField(PropertyInfo info)
        {
            return new UnifiedField($"{info.DeclaringType}-{info.Name}", GetFieldType(info), GetValueType(info))
            {
                ...
                IsCustom = false,
                Label = info.Name,
                SourceType = (info.ReflectedType ?? info.DeclaringType)?.FullName
            };
        }
