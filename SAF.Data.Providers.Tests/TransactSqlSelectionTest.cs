// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransactSqlSelectionTest.cs" company="TractManager, Inc.">
...
[dbo].[FakeData].[AnotherValueColumn] IN (@6, @7, @8, @9)";
            ...
            Assert.AreEqual(ExpectedSelection, transactionSelection.SelectionStatement);
            Assert.AreEqual(ExpectedContains, transactionSelection.ContainsStatement);
            Assert.AreEqual(ExpectedRemoval, transactionSelection.RemovalStatement);
        }
