// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SerializableCollection.cs" company="Startitecture">
//   Copyright 2017 Startitecture. All rights reserved.
// </copyright>
// <summary>
//   Base class for generic serializable collections.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Startitecture.Core
{
    ...
    /// <remarks>Use as a base class for implementing a generic serializable collection. The <see cref="System.SerializableAttribute"/> 
    /// and <see cref="System.Xml.Serialization.XmlIncludeAttribute"/> must be set for the subclass for XML serialization to work properly.</remarks>
    /// <example>
    /// <code>
    ...
    public class SerializableCollection<T> : ICollection<T>
    {
        ...
        [DebuggerHidden]
        protected SerializableCollection(IEnumerable<T> values)
        {
        ...
        /// <exception cref="System.IndexOutOfRangeException">The specified index is outside the bounds of the collection.</exception>
        [DebuggerHidden]
        ...
        /// <summary>
        /// Copies the elements of the <see cref="SerializableCollection&lt;T&gt;"/> to an <see cref="System.Array"/>, 
        ...
        public override bool Equals(object obj)
        {
            return 
                ...
                (obj is SerializableCollection<T> && this.Equals(obj as SerializableCollection<T>));
        }
        ...
        {
            return obj != null && Evaluate.CollectionEquals(this.valueList, obj.valueList);
        }
        ...
        /// </summary>
        private sealed class GenericEnumerator : IEnumerator<T>
        {
            /// <summary>
            /// The collection of items.
            /// </summary>
            private readonly SerializableCollection<T> collection;
            ...
            /// A value indicating whether the Dispose() method is being called (true) or the object is being finalized (false).
            /// </param>
            [DebuggerHidden]
