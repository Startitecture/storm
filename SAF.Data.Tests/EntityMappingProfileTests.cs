// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EntityMappingProfileTests.cs" company="TractManager, Inc.">
...
namespace SAF.Data.Tests
{
    ...
    public class EntityMappingProfileTests
    {
        ...
        public void MapTo_InheritedEntityFromKey_MatchesExpected()
        {
            ...
            Assert.AreEqual(543, createdBy.FakeMultiReferenceEntityId);
        }
        ...
        public void MapTo_SuperClassFromKey_MatchesExpected()
        {
            ...
            Assert.AreEqual(8743, actual.MySuperClassId);
        }
        ...
        public void CreateDependencyMap_MapFakeDependencyFromKey_MatchesExpected()
        {
            ...
            Assert.AreEqual(expected.FakeDependencyEntityId, actual.FakeDependencyEntityId);
        ...
        public void CreateDependencyMap_GetKeyFromFakeDependency_MatchesExpected()
        {
            ...
            Assert.AreEqual(expected.FakeDependencyEntityId, actual);
        }
        ...
        public void Map_ListOfComplexEntityToEntityFromRaisedRow_MatchesExpected()
        {
            ...
            using (var repositoryProvider = RepositoryMockFactory.CreateProvider(mapper))
            {
                ...
                foreach (var expectedEntity in expected)
                {
                    ...
                    Assert.AreEqual(expectedEntity.FakeComplexEntityId, actualEntity.FakeComplexEntityId);
                    Assert.AreEqual(expectedEntity.CreatedByFakeMultiReferenceEntityId, actualEntity.CreatedByFakeMultiReferenceEntityId);
                    Assert.AreEqual(expectedEntity.FakeDependentEntityId, actualEntity.FakeDependentEntityId);
                    ...
                    Assert.AreEqual(expectedEntity.ModifiedByFakeMultiReferenceEntityId, actualEntity.ModifiedByFakeMultiReferenceEntityId);
