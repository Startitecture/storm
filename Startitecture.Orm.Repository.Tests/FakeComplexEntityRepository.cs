// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FakeComplexEntityRepository.cs" company="Startitecture">
...
namespace Startitecture.Orm.Repository.Tests
{
    ...
    public class FakeComplexEntityRepository : EntityRepository<FakeComplexEntity, FakeComplexRow>
    {
        ...
        /// The entity mapper.
        /// </param>
        public FakeComplexEntityRepository(IRepositoryProvider repositoryProvider, IEntityMapper entityMapper)
        ...
        /// </param>
        /// <returns>
        /// The <see cref="Startitecture.Orm.Testing.Model.FakeComplexEntity"/>.
        /// </returns>
        ...
        protected override void LoadChildren([NotNull] FakeComplexEntity entity, [NotNull] IRepositoryProvider provider)
        {
            ...
            var childRepo = new FakeChildEntityRepository(this.RepositoryProvider, this.EntityMapper);
