// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CollectionComparer.cs" company="TractManager, Inc.">
...
namespace SAF.Core
{
    ...
    public class CollectionComparer<T> : IEqualityComparer<IEnumerable<T>>
    {
        ...
        /// <summary>
        /// Returns a dictionary of elements of an <see cref="IEnumerable&lt;T&gt;"/> as keys and their placement in 
        /// the <see cref="IEnumerable&lt;T&gt;"/> as values.
        /// </summary>
        /// <param name="enumerable">The <see cref="IEnumerable&lt;T&gt;"/> to retrieve an ordered element dictionary for.</param>
        /// <param name="nullCount">The number of null values within the <see cref="IEnumerable&lt;T&gt;"/>.</param>
        /// <returns>
        /// A dictionary of elements of an <see cref="IEnumerable&lt;T&gt;"/> as keys and their placement in the 
        /// <see cref="IEnumerable&lt;T&gt;"/> as values.
        /// </returns>
