// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FakeSubRow.cs" company="TractManager, Inc.">
...
namespace SAF.Testing.Common
{
    ...
    /// </summary>
    [TableName("FakeSub")]
    [PrimaryKey("FakeSubEntityId")]
    public class FakeSubRow : TransactionItemBase, IEquatable<FakeSubRow>, ICompositeEntity
    {
        /// <summary>
        /// The comparison properties.
        /// </summary>
        private static readonly Func<FakeSubRow, object>[] ComparisonProperties =
            {
        ...
        /// </returns>
        public static bool operator ==(FakeSubRow valueA, FakeSubRow valueB)
        {
            return EqualityComparer<FakeSubRow>.Default.Equals(valueA, valueB);
        }
        ...
        public bool Equals(FakeSubRow other)
        {
