// --------------------------------------------------------------------------------------------------------------------
// <copyright file="FakeChildRow.cs" company="TractManager, Inc.">
...
namespace SAF.Testing.Common
{
    ...
    public class FakeChildRow : TransactionItemBase, ICompositeEntity
    {
        ...
        /// </summary>
        private static readonly IEnumerable<IEntityRelation> FakeChildRelations = new TransactSqlFromClause<FakeChildRow>()
        ...
        /// </summary>
        [RelatedEntity(typeof(FakeComplexEntity), false)]
