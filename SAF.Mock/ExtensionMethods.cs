...
namespace SAF.Mock
{
    ...
    public static class ExtensionMethods
    {
            ...
            repositoryProvider.Stub(provider => provider.Save(Arg<TDataItem>.Is.Anything, Arg<ItemSelection<TDataItem>>.Is.Anything)).Return(null)
                .WhenCalled(
                    invocation =>
                    {
                        ...
                        var primaryKeyAttribute = item.GetType().GetCustomAttributes<PrimaryKeyAttribute>().FirstOrDefault();
        ...
        /// </typeparam>
        /// <returns>
        /// The <see cref="IRepositoryAdapter"/> with methods stubbed for an existing item.
        /// </returns>
        ...
        /// </typeparam>
        /// <returns>
        /// The <see cref="IRepositoryAdapter"/> with methods stubbed for a new item.
        /// </returns>
        ...
        /// </typeparam>
        /// <returns>
        /// The <see cref="IRepositoryAdapter"/> with methods stubbed for a list of items.
        /// </returns>
