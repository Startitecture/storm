...
namespace SAF.Data.Providers
{
    ...
    public class StructuredInsertCommand<TStructure> : StructuredSqlCommand<TStructure>
    {
        ...
        {
            this.itemDefinition = Singleton<DataItemDefinitionProvider>.Instance.Resolve<TDataItem>();
            return this;
        }
        ...
        public StructuredInsertCommand<TStructure> SelectResults(params Expression<Func<TStructure, object>>[] matchProperties)
        {
            ...
            this.selectionAttributes.AddRange(matchProperties.Select(x => x.GetPropertyName()).Select(structureDefinition.Find));
            return this;
        }
        ...
        private void SelectOutput(IEntityDefinition structureDefinition, StringBuilder commandBuilder)
        {
            ...
            var nonKeyAttributes =
                structureDefinition.AllAttributes.Except(selectedKeyAttributes.Select(x => x.Attribute))
                    .Select(x => new { Column = $"tvp.[{x.PropertyName}]", Attribute = x });
