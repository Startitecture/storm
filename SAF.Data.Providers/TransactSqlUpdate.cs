...
namespace SAF.Data.Providers
{
    ...
    /// </typeparam>
    public class TransactSqlUpdate<TItem>
    {
        #region Constants
...
{1}";
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactSqlUpdate{TItem}"/> class.
        /// </summary>
        /// <param name="selection">
        /// The selection of items to update.
        /// </param>
        public TransactSqlUpdate(ItemSelection<TItem> selection)
        {
        ...
        /// </param>
        /// <returns>
        /// The current <see cref="T:SAF.Data.Providers.TransactSqlUpdate`1"/>.
        /// </returns>
        public TransactSqlUpdate<TItem> Set(TItem item)
        {
        ...
        /// The current <see cref="T:SAF.Data.Providers.TransactSqlUpdate`1"/>.
        /// </returns>
        public TransactSqlUpdate<TItem> Set(TItem item, params EntityAttributeDefinition[] attributes)
        {
        ...
        /// The current <see cref="T:SAF.Data.Providers.TransactSqlUpdate`1"/>.
        /// </returns>
        public TransactSqlUpdate<TItem> Set(TItem item, params Expression<Func<TItem, object>>[] properties)
        {
            this.attributesToSet.Clear();
        ...
        /// </returns>
        private string CreateUpdateStatement(TransactSqlUpdate<TItem> operation)
        {
