// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PetaPocoRepositoryProvider.cs" company="TractManager, Inc.">
//   Copyright 2013 TractManager, Inc. All rights reserved.
// </copyright>
// <summary>
//   Provides a concrete implementation for a PetaPoco database repository.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SAF.Data.Providers
{
    ...
    /// </typeparam>
    public sealed class PetaPocoRepositoryProvider<TContext> : IRepositoryProvider, IDatabaseContextProvider
        where TContext : Database
    {
        ...
        /// <summary>
        /// The PetaPoco data context for this repository. Required to maintain a specific Exists method signature.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:SAF.Data.Providers.PetaPocoRepositoryProvider`1"/> class.
        /// </summary>
        /// <param name="entityMapper">
        /// The entity mapper.
        /// </param>
        public PetaPocoRepositoryProvider(IEntityMapper entityMapper)
        ...
        /// The entity mapper.
        /// </param>
        public PetaPocoRepositoryProvider(IRepositoryAdapterFactory adapterFactory, IEntityMapper entityMapper)
        ...
        /// The entity mapper.
        /// </param>
        public PetaPocoRepositoryProvider(IDatabaseFactory<TContext> databaseFactory, IEntityMapper entityMapper)
        ...
        /// The entity mapper.
        /// </param>
        public PetaPocoRepositoryProvider(
        ...
        /// </typeparam>
        public void Execute<TItem>(ItemOperation<TItem> itemOperation)
        {
            if (itemOperation == null)
            {
                throw new ArgumentNullException(nameof(itemOperation));
            }

            this.CheckDisposed();
            this.dataContext.Execute(itemOperation.ExecutionStatement, itemOperation.ParameterValues.ToArray());
        }
