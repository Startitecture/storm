...
namespace SAF.Data.Providers
{
    ...
    /// </typeparam>
    public class TransactSqlSelection<TItem> : ItemSelection<TItem>
        where TItem : new()
    {
        /// <summary>
...
{0}
        ...
        /// The selectors of the properties to evaluate.
        /// </param>
        internal TransactSqlSelection(TItem lowerLimit, TItem upperLimit, params Expression<Func<TItem, object>>[] selectors)
            : this()
        {
            ////this.SetRelations(lowerLimit);
