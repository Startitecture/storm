// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EntityMappingProfile.cs" company="TractManager, Inc.">
...
namespace SAF.Data
{
        ...
        where TDataItem : ITransactionContext
    {
        ...
        /// </typeparam>
        /// <returns>
        /// The current <see cref="T:SAF.Data.IEntityMappingProfile`2"/>.
        /// </returns>
...
*/
        ...
        /// </param>
        /// <returns>
        /// The current <see cref="IEntityMappingProfile{TEntity, TDataItem}"/> with the property mapped between the entity and the 
        /// data item.
        /// </returns>
...
*/
            ...
            [NotNull] Expression<Func<TRelation, TEntityKey>> entityKey)
        {
            ...
            this.CreateMap<TDataKey, TRelation>()
        ...
        /// <summary>
        /// Gets the entity to row property name selection mapping.
        /// </summary>
        /// <param name="selection">
        /// The selection to map.
        /// </param>
        /// <returns>
        /// A <see cref="T:SAF.Data.PropertyNameSelection`1"/> mapped for the data item type.
        /// </returns>
        protected virtual PropertyNameSelection<TDataItem> TranslateNameSelection(PropertyNameSelection<TEntity> selection)
        {
            if (selection == null)
            {
            ...
            return new PropertyNameSelection<TDataItem>(selection.PropertiesToInclude.ToArray());
        }
            ...
            Expression<Func<TDataItem, TColumn>> dataItemColumn)
        {
            ...
            var propertyInfo = ExtensionMethods.GetProperty(entityProperty);
