...
namespace Startitecture.Orm.Testing.Model
{
    ...
    public class FormSubmission : IEquatable<FormSubmission>
    {
        ...
        /// </param>
        /// ///
        public FormSubmission(PM.Person submittedBy, DateTimeOffset submittedTime, long? formSubmissionId)
        {
        ...
        /// </summary>
        public PM.Person SubmittedBy { get; private set; }
        ...
        /// </param>
        public void SaveDraft([NotNull] PM.Person person, [NotNull] params FormSubmissionValue[] values)
        {
            if (person == null)
            {
        ...
        /// The values to submit.
        /// </param>
        public void Submit([NotNull] PM.Person person, [NotNull] params FormSubmissionValue[] values)
        {
            if (person == null)
            {
                throw new ArgumentNullException(nameof(person));
