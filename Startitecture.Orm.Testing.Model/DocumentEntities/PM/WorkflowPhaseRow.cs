...
namespace Startitecture.Orm.Testing.Model.DocumentEntities.PM
{
    ...
    public partial class WorkflowPhaseRow : ICompositeEntity, IEquatable<WorkflowPhaseRow>
    {
        ...
        /// </summary>
        [Relation]
        public FieldEntities.UserRow PhaseOwner { get; set; }
        ...
        {
            return $"{this.ProcessPhase?.Name ?? Convert.ToString((long)this.WorkflowPhaseId)}:Status={this.ProcessPhaseStatusId}";
        }
