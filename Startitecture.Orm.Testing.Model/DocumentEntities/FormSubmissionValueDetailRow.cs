    ...
    public class FormSubmissionValueDetailRow : FormSubmissionValueRow
    {
        ...
        private static readonly IEnumerable<IEntityRelation> FormSubmissionValueDetailRelations =
            new SqlFromClause<FormSubmissionValueRow>()
                ...
                .InnerJoin<FieldEntities.UnifiedFieldValueRow, UnifiedFieldRow>(row => row.UnifiedFieldId, row => row.UnifiedFieldId)
                ...
                .LeftJoin<FieldEntities.UnifiedFieldValueRow, FieldEntities.UnifiedIntegerValueRow>(row => row.UnifiedFieldValueId, row => row.UnifiedFieldValueId)
                .LeftJoin<FieldEntities.UnifiedIntegerValueRow, ml_custom_field_valueRow>(row => row.IntegerValue, row => row.mlcfv_id)
                .LeftJoin<FieldEntities.UnifiedFieldValueRow, FieldEntities.UnifiedDateValueRow>(row => row.UnifiedFieldValueId, row => row.UnifiedFieldValueId)
                .LeftJoin<FieldEntities.UnifiedFieldValueRow, FieldEntities.UnifiedStringValueRow>(row => row.UnifiedFieldValueId, row => row.UnifiedFieldValueId)
                .LeftJoin<FieldEntities.UnifiedFieldValueRow, FieldEntities.UnifiedNumericValueRow>(row => row.UnifiedFieldValueId, row => row.UnifiedFieldValueId)
                .Relations;
        ...
        /// </summary>
        [RelatedEntity(typeof(FieldEntities.UnifiedIntegerValueRow))]
        ...
        /// </summary>
        [RelatedEntity(typeof(FieldEntities.UnifiedDateValueRow))]
        ...
        /// </summary>
        [RelatedEntity(typeof(FieldEntities.UnifiedStringValueRow))]
        ...
        /// </summary>
        [RelatedEntity(typeof(FieldEntities.UnifiedNumericValueRow))]
