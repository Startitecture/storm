...
namespace Startitecture.Orm.Testing.Model.PM
{
    ...
    public class FormSubmissionValue : UnifiedFieldValue, IEquatable<FormSubmissionValue>
    {
        ...
        /// The unified field.
        /// </param>
        public FormSubmissionValue(PM.UnifiedField unifiedField)
            : base(unifiedField)
        {
        }
        ...
        /// </param>
        public FormSubmissionValue(PM.UnifiedField unifiedField, long formSubmissionId, long? unifiedFieldValueId)
