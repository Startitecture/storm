...
namespace Startitecture.Orm.Testing.Model
{
    ...
    public class FormVersion : IEquatable<FormVersion>, IComparable, IComparable<FormVersion>, ITrackChanges
    {
        ...
        /// The form version ID.
        /// </param>
        public FormVersion(Form form, int revision, PM.Person createdBy, DateTimeOffset createdTime, int? formVersionId)
            : this(form)
        {
            this.Form = form;
        ...
        /// </summary>
        public PM.Person CreatedBy { get; private set; }
        ...
        /// </summary>
        public PM.Person LastModifiedBy { get; private set; }
        ...
        /// </param>
        public void UpdateChangeTracking(PM.Person editor)
        {
        ...
        /// </param>
        internal void AddTo([NotNull] Form form, [NotNull] PM.Person editor)
        {
            if (editor == null)
            {
        ...
        /// </param>
        private void UpdateChangeTracking([NotNull] PM.Person editor, DateTimeOffset modifiedTime)
        {
            if (editor == null)
            {
                throw new ArgumentNullException(nameof(editor));
