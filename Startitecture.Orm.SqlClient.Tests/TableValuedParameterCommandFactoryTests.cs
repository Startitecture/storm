// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TableValuedParameterCommandFactoryTests.cs" company="Startitecture">
...
namespace Startitecture.Orm.SqlClient.Tests
{
    ...
    /// <summary>
    /// Tests the <see cref="TableValuedParameterCommandFactory"/> class.
    /// </summary>
    [TestClass]
    public class TableValuedParameterCommandFactoryTests
    {
        /// <summary>
