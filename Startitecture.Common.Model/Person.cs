...
namespace Startitecture.Common.Model
{
    ...
    public class Person : IEquatable<Person>
    {
        ...
        /// </summary>
        /// <param name="securityIdentifier">
        /// The security identifier.
        /// </param>
        public Person(string securityIdentifier)
        ...
        public Person(string securityIdentifier, int? personId)
        {
            ...
            {
                throw new ArgumentException(ErrorMessages.ValueCannotBeNullOrWhiteSpace, nameof(securityIdentifier));
            }
        ...
        {
            return $"{this.FirstName} {this.LastName} ({this.SecurityIdentifier})";
        }
